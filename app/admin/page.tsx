...
export default function AdminPage() {
  ...
  const metrics = useMemo(() => {
    ...
    return { totalRevenue, pending, processing, shipped };
  }, [orders]);
        ...
        <div className="rounded-[2rem] bg-slate-950 p-6 text-white">
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-black">Order Dashboard</h1>
              <p className="mt-2 text-slate-300">
                View, search, and manage Supabase orders. Mode: {mode}
              </p>
            </div>
            <div className="flex gap-3">
              <a href="/" className="rounded-2xl bg-white px-5 py-3 font-black text-slate-950">
                Back to Store
              </a>
              ...
              <tbody>
                {filteredOrders.length === 0 ? (
                  ...
                  <tr key={order.id} className="border-b">
                    ...
                    <td>
                      <button onClick={() => setSelectedOrder(order)} className="rounded-xl bg-slate-950 px-4 py-2 font-bold text-white">
                        View
                      </button>
                    </td>
                  </tr>
